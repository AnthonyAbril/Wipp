...
export default function EditProfileScreen({ navigation, route }: Props) {
  ...
  const [image, setImage] = useState<string | null>(route.params?.currentImage || null);
  ...
  const uploadImage = async () => {
    ...
    setLoading(true);
    try {
      await imageAPI.uploadProfileImage(image);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        <Text style={styles.subtitle}>Selecciona una imagen para tu perfil</Text>
        ...
        >
          {image ? (
            ...
            <View style={styles.placeholder}>
              ...
              <Text style={styles.placeholderSubtext}>Seleccionar imagen</Text>
            </View>
          )}
        </TouchableOpacity>
